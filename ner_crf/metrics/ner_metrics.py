...
from ner_crf.processors.utils_ner import get_entities
...
class SeqEntityScore(object):
    ...
    def result(self):
        ...
        for type_, count in origin_counter.items():
            ...
            recall, precision, f1_score = self.compute(origin, found, right)
            class_info[type_] = {
        ...
        recall, precision, f1_score = self.compute(origin, found, right)
        return {'precision': precision, 'recall': recall, 'f1': f1_score}, class_info
